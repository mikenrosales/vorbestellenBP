...
<head>
  ...
  <title>Vorbestellen | About</title>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Info</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{% url 'vorbestellenapp:about_view' %}" class="active">About Us</a></li>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <h2>This <span class="highlight">Project</span></h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{% static 'img/team/mike.jpg' %}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Mikerossti Ponce</h4>
                <span>Project Manager / Back-end</span>
                <p>Aspiring Web Developer / Artist</p>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{% static 'img/team/otsuki.jpg' %}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Mcwayne Otsuki</h4>
                <span>Fullstack Developer</span>
                <p>Always has an eye for creativity with simplicity</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{% static 'img/team/miko.jpg' %}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Mikole Rosales</h4>
                <span>Front-end and Design</span>
                <p>If life gives you lemon, add vodka.</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
