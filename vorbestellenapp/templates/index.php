      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url({% static 'img/slide/slide-2.jpg' %})" >
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">A <span class="#">Space</span> to <span>Work, Meet, and Relax</span></h2>
              <p class="animate__animated animate__fadeInUp">Bringing people together to a creative space where engaging minds meet.</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
              &ensp;
              <a href="{% url 'vorbestellenapp:pricing_view' %}" class="btn-get-into animate__animated animate__fadeInUp scrollto">Book Now</a>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url({% static 'img/slide/slide-3.jpg' %})">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown"><span class="#">Personal Approach</span> Not Just Business</h2>
              <p class="animate__animated animate__fadeInUp">Getting you ready for success and empowerment. Make it happen.</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
              &ensp;
              <a href="{% url 'vorbestellenapp:pricing_view' %}" class="btn-get-into animate__animated animate__fadeInUp scrollto">Book Now</a>
            </div>
    ...
    <section id="about" class="about">
      <div class="container">                
        ...
        <div class="row content">
          <div class="col-lg-6">
            <h2>Get to know this <span class="highlight">project</span></h2>
            <h3>Our aim is to provide a hassle-free and convenient platform for people, of any age and profession, to meet their needs to reserve top quality conference rooms.</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              The project's purpose is to connect people by making all ends meet in a creative space where they can develop possibilites for the future. Our service provides an effective and efficient method to reserve available conference rooms anytime, and anywhere.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Provide high quality conference rooms</li>
              <li><i class="ri-check-double-line"></i> Accommodate people of any profession with valid IDs</li>
              <li><i class="ri-check-double-line"></i> Serve great minds to envision success </li>
            </ul>
            <p class="fst-italic">
              Gain the edge and reserve now!
            </p>
          </div>
        </div>
