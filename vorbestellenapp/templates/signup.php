		  ...
		  <nav id="navbar" class="navbar">
			<ul>
			  ...
			  <li class="dropdown"><a href="#"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
				<ul>
				  <li><a href="{% url 'vorbestellenapp:pricing_view' %}">Quick Booking</a></li>
		  ...
		  <div class="container">
			  <div class="row">
				  <div class="col-sm-6">
					...
					<img src="{% static 'img/portfolio/square-temp.jpg' %}" style="width: 500px; height: 500px;" alt="">
				  </div>
				  <div class="col-sm-5">
					<form id="form1" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
						{% csrf_token %}
						<br><br><br>
						<h1><span class="highlight">Sign</span> Up</h1><br>
						<div class="form-group">
							<input type="text" class="form-control rounded-left" id="username" name="username" placeholder="Username">
						</div><br>
						<div class="form-group">
							<input type="email" class="form-control rounded-left" id="email" name="email" placeholder="Email">
						</div><br>
						<div class="form-group">
							<input type="password" class="form-control rounded-left" id="password" name="password" placeholder="Password">
						</div><br>
						<div class="form-group">
							<input type="password" class="form-control rounded-left" id="cpassword" name="cpassword" placeholder="Confirm Password">
						</div>
						 <br>
						 <div class="form-group">
							<br>
							<input type="submit" class="form-control btn btn-danger rounded submit px-3" value="Sign Up">
						  </div>
						  <br>
						  <div class="text-center">
							<p>Already have an account? <a href="#" data-toggle="modal" data-target="#exampleModalCenter">Sign in</a></p>
						  </div>
					</form>
