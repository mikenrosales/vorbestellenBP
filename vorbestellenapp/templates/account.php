...
<head>
	...
	<head>
		...
		<title>Vorbestellen | Register</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				...
				<img src="{% static 'img/portfolio/square-temp.jpg' %}" style="width: 500px; height: 601px;" alt="">
			</div>
			<div class="col-sm-5">
				{% for users in users %}
				<form id="form1" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
					{% csrf_token %}
					<br><br>
					<h1><span class="highlight">Account</span> Details</h1>
					<h3><span class="highlight">Status:</span> {{users.status}}</h3><br>
					<!-- <div class="col-8" style="padding: 10px; display: inline-block; width: 634px;"></div> -->
					<div class="form-row">

						<div class="col-8" style="padding: 10px; display: inline-block; width: 500px;">
							<label>Username</label>
							<input type="text" class="form-control rounded-left" id="username" name="username" value="{{users.username}}" placeholder="Username" readonly>
						</div>
						<div class="col-8" style="padding: 10px; display: inline-block; width: 500px;">
							<label>Email</label>
							<input type="email" class="form-control rounded-left" id="email" name="email" value="{{users.email}}" placeholder="Email" readonly>
						</div>
						<div class="col-8" style="padding: 10px; display: inline-block; width: 248px;">
							<label>First Name</label>
							<input type="text" class="form-control rounded-left" id="first_name" name="first_name" placeholder="First Name" value="{{users.first_name}}">
						</div>
						<div class="col-8" style="padding: 10px; display: inline-block; width: 248px;">
							<label>Last Name</label>
							<input type="text" class="form-control rounded-left" id="last_name" name="last_name" placeholder="Last Name" value="{{users.last_name}}">
						</div>
						<div class="col-8" style="padding: 10px; display: inline-block; width: 500px;">
							<label>Contact No.</label>
							<input type="text" class="form-control rounded-left" id="contact" name="contact" placeholder="Contact No." value="{{users.contact}}">
						</div>
						<div class="col-8" style="padding: 10px; display: inline-block; width: 248px;">
							<label>Barangay</label>
							<input type="text" class="form-control rounded-left" id="barangay" name="barangay" placeholder="Barangay" value="{{users.barangay}}">
						</div>
						<div class="col-8" style="padding: 10px; display: inline-block; width: 248px;">
							<label>City</label>
							<input type="text" class="form-control rounded-left" id="city" name="city" placeholder="City" value="{{users.city}}">
						</div>

						<div class="col-8" style="padding: 10px; display: inline-block; width: 500px;">
							<br>
							{% endfor %}
							<input type="submit" class="form-control btn btn-danger rounded submit px-3" value="Save">
						</div>
						<br>
					</div>
