...
<body>
  ...
  <main id="main">
      ...
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="#addUserModal" class="btn btn-secondary" data-toggle="modal"><i
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <!-- AutoIncremented -->
              <td style="text-align: center; font-weight: bold;">{{users.user_id}}</td>
              <td>{{users.username}}</td>
              <td class="hidetext">{{users.password}}</td>
              ...
              <td>
                <a href="#" class="edit" type="button" data-toggle="modal"
                  data-target="#editUserModal-{{users.user_id}}"><i class="material-icons" data-toggle="tooltip"
                    title="Edit">&#xE254;</i></a>
                <a href="#" class="delete" data-toggle="modal" data-target="#deleteUserModal-{{users.user_id}}"><i
                    class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
              </td>
            </tr>
          </tbody>
          <!-- Edit Modal HTML -->
          <div id="editUserModal-{{users.user_id}}" class="modal fade">
            <form id="updateForm-{{users.user_id}}" method="POST" enctype="multipart/form-data">
              {% csrf_token %}
              {{ form.as_p }}
              <div class="modal-dialog modal-dialog-centered" style="min-width:58.5%">
                <div class="modal-content">
                  ...
                  <div class="modal-body"><p>Cannot Change user id and username as it is a fixed foreign key to other tables.</p>
                    <div class="form-group" style="padding: 3px; display: inline-block; width: 200px;">
                      <!-- AutoIncremented -->
                      <label>User ID</label>
                      <input type="text" id="upuser_id" name="upuser_id" class="form-control" placeholder="auto incremented"
                        value="{{users.user_id}}" readonly required>
                    </div>
                    <div class="form-group" style="padding: 3px; display: inline-block; width: 400px;">
                      <label>Username</label>
                      <input type="text" id="upusername" name="upusername" class="form-control" value="{{users.username}}"
                      readonly required>
                    </div>
                    <div class="form-group" style="padding: 3px; display: inline-block; width: 200px;">
                      <label>Password</label>
                      <input type="password" id="uppassword" name="uppassword" class="form-control"
                        value="{{users.password}}" required>
                    </div>
                    <div class="form-group" style="padding: 3px; display: inline-block; width: 200px;">
                      <label>Email</label>
                      <input type="text" id="upemail" name="upemail" class="form-control" value="{{users.email}}" required>
                    </div>
                    <br>
                    <br>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" id="btnUpdateUser" name="btnUpdateUser"
    ...
    <!-- Delete Modal HTML -->
    <div id="deleteUserModal-{{users.user_id}}" class="modal fade">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="text" id="deluser_id" name="deluser_id" class="form-control" placeholder="auto incremented"
                value="{{users.user_id}}" readonly hidden required>
              <p>Are you sure you want to delete records?</p>
              <p class="highlight"><small>This action cannot be undone.</small></p>
            </div>
            <div class="modal-footer">
              <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
              <input type="submit" id="btnDeleteUser" name="btnDeleteUser" class="btn btn-danger" value="Delete">
            </div>
      </form>
    </div>
    </div>
        ...
        <div class="modal-content">
          <form id="form1" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="modal-footer">
                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                <button type="submit" id="btnAddUser" name="btnAddUser" class="btn btn-secondary">SAVE</button>
              </div>
          </form>
        </div>
      </div>
