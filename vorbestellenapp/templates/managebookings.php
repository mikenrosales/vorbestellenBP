        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{reser.contact}}</td>
              <td>
              <a href="#" class="edit" data-toggle="modal" data-target="#acceptReservationModal-{{reser.reservation_id}}">Accept</a>
                <a href="#" class="delete" type="submit" id="RejectPending">Reject</a>
              </td>
            </tr>
          </tbody>
    <!-- Accept Modal HTML -->
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"><span class="highlight">Accept</span> Reservation</h4>
            </div>
            <div class="modal-body">
              ...
              <p>Are you sure you want to confirm reservation?</p>
            </div>
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <a href="#" class="edit" data-toggle="modal" data-target="#changeReservationModal-{{vreser.reservation_id}}">Undo</a>
              <a href="#" class="delete" data-toggle="modal" data-target="#deleteReservationModal-{{vreser.reservation_id}}">Delete</a>
              </td>
            </tr>
          </tbody>
    <!-- Undo Modal HTML -->
